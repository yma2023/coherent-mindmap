...
export const LandingPage: React.FC = () => {
    ...
    const handleScroll = () => {
      ...
      if (featuresRef.current) {
        ...
        const relativeScroll =
          scrollPosition - featuresTop + window.innerHeight / 2;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 relative overflow-hidden">
      ...
      {/* メインコンテンツ */}
      <div
        className={`relative z-10 min-h-screen flex flex-col transition-all duration-1000 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
      >
        {/* ヘッダー */}
      ...
      <section
        ref={featuresRef}
        className="relative z-10 py-32 px-6 min-h-screen"
      >
        <div className="max-w-7xl mx-auto">
          {/* セクションタイトル */}
          <div
            className={`text-center mb-20 transition-all duration-1000 ${visibleSections.has("features") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            {/* 画像スライダー */}
            <div
              className={`relative transition-all duration-1000 ${visibleSections.has("features") ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-8"}`}
            >
            ...
            {/* 機能説明 */}
            <div
              className={`space-y-8 transition-all duration-1000 ${visibleSections.has("features") ? "opacity-100 translate-x-0" : "opacity-0 translate-x-8"}`}
            >
      ...
      <section
        ref={aiSectionRef}
        className="relative z-10 py-32 px-6 min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100"
      >
        <div className="max-w-7xl mx-auto">
          <div
            className={`transition-all duration-1000 ${visibleSections.has("ai") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h4 className="text-xl font-bold text-slate-800 mb-4">
                  {t("landing.contextUnderstanding")}
                </h4>
                <p className="text-slate-600 leading-relaxed">
      ...
      <section
        ...
        className="relative z-10 py-32 px-6 min-h-screen bg-gradient-to-br from-purple-50 to-pink-100"
      >
        <div className="max-w-7xl mx-auto">
          <div
            className={`transition-all duration-1000 ${visibleSections.has("collaboration") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
          >
            <div className="text-center mb-20">
              ...
              <div>
                <div className="space-y-8">
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <h4 className="text-2xl font-bold text-slate-800 mb-4">
                        {t("landing.permissionManagement")}
                      </h4>
                      <p className="text-slate-600 leading-relaxed text-lg">
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50">
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <span className="text-slate-600 font-medium">
                      {isJapanese ? "3人が編集中" : "3 people editing"}
                    </span>
                  ...
                  <div className="space-y-4">
                    <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
                      <p className="text-sm text-blue-800 font-medium">
                        {isJapanese
                          ? "Alice がノード「マーケティング戦略」を追加しました"
                          : 'Alice added node "Marketing Strategy"'}
                      </p>
                      <p className="text-xs text-blue-600 mt-1">
                        {isJapanese ? "2分前" : "2 minutes ago"}
                      </p>
                    </div>
                    <div className="bg-purple-50 border-l-4 border-purple-500 p-4 rounded-r-lg">
                      <p className="text-sm text-purple-800 font-medium">
                        {isJapanese
                          ? "Bob がコメントを追加: 「この部分をもう少し詳しく...」"
                          : 'Bob added comment: "Let\'s elaborate on this part..."'}
                      </p>
                      <p className="text-xs text-purple-600 mt-1">
                        {isJapanese ? "5分前" : "5 minutes ago"}
                      </p>
                    </div>
                    <div className="bg-emerald-50 border-l-4 border-emerald-500 p-4 rounded-r-lg">
                      <p className="text-sm text-emerald-800 font-medium">
                        {isJapanese
                          ? "Carol が接続を作成しました"
                          : "Carol created a connection"}
                      </p>
                      <p className="text-xs text-emerald-600 mt-1">
                        {isJapanese ? "8分前" : "8 minutes ago"}
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <section
        ...
        className="relative z-10 py-32 px-6 min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100"
      >
        <div className="max-w-7xl mx-auto">
          <div
            className={`transition-all duration-1000 ${visibleSections.has("performance") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
          >
            <div className="text-center mb-20">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  <h4 className="text-3xl font-bold text-slate-800 mb-6">
                    {t("landing.optimizedArchitecture")}
                  </h4>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h5 className="text-lg font-semibold text-slate-800 mb-2">
                          {t("landing.edgeComputing")}
                        </h5>
                        <p className="text-slate-600">
                          {t("landing.edgeComputingDescription")}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h5 className="text-lg font-semibold text-slate-800 mb-2">
                          {t("landing.incrementalSync")}
                        </h5>
                        <p className="text-slate-600">
                          {t("landing.incrementalSyncDescription")}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h5 className="text-lg font-semibold text-slate-800 mb-2">
                          {t("landing.webAssemblyOptimization")}
                        </h5>
                        <p className="text-slate-600">
                          {t("landing.webAssemblyOptimizationDescription")}
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4 font-mono text-sm">
                      <div className="flex justify-between">
                        <span className="text-green-400">
                          {isJapanese ? "CPU使用率:" : "CPU Usage:"}
                        </span>
                        <span>12%</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-blue-400">
                          {isJapanese ? "メモリ:" : "Memory:"}
                        </span>
                        <span>245MB / 2GB</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        <span className="text-orange-400">
                          {isJapanese ? "アクティブノード:" : "Active Nodes:"}
                        </span>
                        <span>1,247</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-pink-400">
                          {isJapanese ? "同期状態:" : "Sync Status:"}
                        </span>
                        <span className="text-green-400">
                          {isJapanese ? "✓ リアルタイム" : "✓ Real-time"}
                        </span>
                      </div>
                    </div>
                  </div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <div
            className={`transition-all duration-1000 ${visibleSections.has("details") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
          >
            <div className="text-center mb-20">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 text-center">
                ...
                <p className="text-slate-600 leading-relaxed">
                  {t("landing.cloudSyncDescription")}
                </p>
              </div>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300 hover:-translate-y-2 text-center">
                ...
                <h3 className="text-xl font-semibold text-slate-800 mb-4">
                  {t("landing.offlineSupport")}
                </h3>
                <p className="text-slate-600 leading-relaxed">
                  {t("landing.offlineSupportDescription")}
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        ref={testimonialsRef}
        className="relative z-10 py-32 px-6 min-h-screen bg-gradient-to-br from-slate-100 to-slate-200"
      >
        <div className="max-w-7xl mx-auto">
          <div
            className={`transition-all duration-1000 ${visibleSections.has("testimonials") ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
          >
            <div className="text-center mb-20">
              <h3 className="text-4xl md:text-5xl font-bold text-slate-800 mb-8">
            ...
            <div className="text-center">
              <div className="inline-flex items-center space-x-8 bg-white/90 backdrop-blur-sm px-12 py-8 rounded-3xl shadow-xl border border-white/50">
                ...
                <div className="text-center">
                  ...
                  <div className="text-slate-600">
                    {t("landing.customerSatisfaction")}
                  </div>
                </div>
              </div>
            </div>
