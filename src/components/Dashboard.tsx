      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-blue-100">{t("dashboard.startWithBlank")}</p>
          </button>
          ...
          >
            ...
            <p className="text-purple-100">{t("dashboard.startWithBlank")}</p>
          </button>
          ...
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300">
            ...
            <p className="text-slate-600">{t("dashboard.peopleWorking")}</p>
          </div>
          ...
          <div className="bg-white/70 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-2">
              {t("dashboard.totalMaps")}
            </h3>
            <p className="text-slate-600">{t("dashboard.mapsCreated")}</p>
          </div>
        </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-1">
                        ...
                        <span className="text-sm text-slate-500">
                          {map.collaborators} {t("dashboard.collaborators")}
                        </span>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2 text-sm text-slate-500">
                    ...
                    <span>
                      {map.updated} {t("dashboard.updated")}
                    </span>
                  </div>
                </div>
              </div>
